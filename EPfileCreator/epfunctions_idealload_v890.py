...
def printversionIDF(versionIDF):
    """Indicated the version of Energy Plus of the baseline file and Energy Plus version to run the output file"""
    if versionIDF == "v860":
        print(versionIDF)
    else: 
        print("This version is not v8.6, for which MLE+ Was designed")

def create_idf_file(input_file_path,iddfile,nbiterations,
                    baselineIDF,versionIDF,
    ...
    for runindex, run in uncertainty.head(n=nbiterations).iterrows(): # only run for the first iteration
        ...
        for wwr_test in range(1,4): #creates a dummy value equal to 1, 2 or 3
            if wwr==wwr_test: #checks if the WWR is 1, 2 or 3
                ...
                add_window_component(idf1,fenestrationfile) # assigns the correct IDF file for the corresponding WWR value
...
# Add CO2 balance  - simple
def addco2(idf1, outdoorco2, trafficmaxco2):
    AddCO2 = idf1.newidfobject("ZONEAIRCONTAMINANTBALANCE")
    AddCO2.Carbon_Dioxide_Concentration = 'Yes'
    AddCO2.Outdoor_Carbon_Dioxide_Schedule_Name = 'Outdoor CO2 Concentration'

    AddCO2Schedule = idf1.newidfobject("SCHEDULE:COMPACT")
    AddCO2Schedule.Name = 'Outdoor CO2 Concentration'
    AddCO2Schedule.Schedule_Type_Limits_Name = "Number"
    AddCO2Schedule.Field_1 = "Through: 12/31"
    AddCO2Schedule.Field_2 = "For: AllDays"
    AddCO2Schedule.Field_3 = "Until: 8:00"
    AddCO2Schedule.Field_4 = outdoorco2
    AddCO2Schedule.Field_5 = "Until: 10:00"
    AddCO2Schedule.Field_6 = trafficmaxco2
    AddCO2Schedule.Field_7 = "Until: 17:00" 
    AddCO2Schedule.Field_8 = outdoorco2
    AddCO2Schedule.Field_9  = "Until: 20:00"
    AddCO2Schedule.Field_10 = trafficmaxco2
    AddCO2Schedule.Field_11 = "Until: 24:00" 
    AddCO2Schedule.Field_12 = outdoorco2
